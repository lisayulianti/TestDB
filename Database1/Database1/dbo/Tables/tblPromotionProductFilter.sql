CREATE TABLE [dbo].[tblPromotionProductFilter] (
    [promotionProductFilterID] INT            IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [tblPromotionProductFilter_pk] PRIMARY KEY CLUSTERED ([promotionProductFilterID] ASC)
);
