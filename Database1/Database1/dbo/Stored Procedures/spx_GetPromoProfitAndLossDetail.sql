...
-- =============================================
CREATE PROCEDURE [dbo].[spx_GetPromoProfitAndLossDetail] 
@PromotionID int,
@IncludeActual bit = 1
AS
BEGIN
...
left join (select * from tblPromoProfitAndLossDetail where promotionID = @promotionID and finCostTypeID = 0) pnlDetail 
...
from tblProfitAndLossHelper helper 
left join (select * from tblPromoProfitAndLossDetail where promotionID = @promotionID and finCostTypeID = 1) pnlDetail 
	on helper.PnLSubGroupItem = pnldetail.pnlSubItem
where helper.PnLSubGroupItem is not null
union
select 
...
from tblProfitAndLossHelper helper 
left join (select * from tblPromoProfitAndLossDetail where promotionID = @promotionID and finCostTypeID = 2 and @IncludeActual = 1) pnlDetail 
	on helper.PnLSubGroupItem = pnldetail.pnlSubItem
where helper.PnLSubGroupItem is not null
union
select 
...
from tblProfitAndLossHelper helper 
left join (select * from tblPromoProfitAndLossDetail where promotionID = @promotionID and finCostTypeID = 5 and @IncludeActual = 1) pnlDetail 
	on helper.PnLSubGroupItem = pnldetail.pnlSubItem
where helper.PnLSubGroupItem is not null
union
select 
...
(
select * from tblPromoProfitAndLossDetail where promotionID = @PromotionID and finCostTypeID = 0
) detail1
inner join 
(
select * from tblPromoProfitAndLossDetail where promotionID = @PromotionID and finCostTypeID = 1
...
inner join 
(
select * from tblPromoProfitAndLossDetail where promotionID = @PromotionID and finCostTypeID = 2 and @IncludeActual = 1
) detail2 on detail1.pnlSubItem = detail2.pnlSubItem) pnlDetail 
	on helper.PnLSubGroupItem = pnldetail.pnlSubItem
where helper.PnLSubGroupItem is not null
union
...
inner join 
(
select * from tblPromoProfitAndLossDetail where promotionID = @PromotionID and finCostTypeID = 5 and @IncludeActual = 1
) detail2 on detail1.pnlSubItem = detail2.pnlSubItem) pnlDetail 
	on helper.PnLSubGroupItem = pnldetail.pnlSubItem
where helper.PnLSubGroupItem is not null
